...
@RestController
@Tag(name = "아이템 평점", description = "아이템 평점 관련 API")
...
public class ItemReviewController {
    ...
    public ResponseEntity<Void> createItemReview(@Validated @RequestBody ItemReviewCreateRequestDto itemReviewCreateRequestDto,
        @CurrentMember Member member, @PathVariable("itemId") Long itemId
    ){
